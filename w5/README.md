...
Scripts in `scripts/` cover deployment, state inspection, transfer submission, and extension management via `deploy.tolk`, `info.tolk`, `send-transfer.tolk`, and `manage-extensions.tolk`. Run them with `acton script w5/scripts/<name>.tolk`.
