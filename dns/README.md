...
This package implements the TON DNS stack, including root resolution, NFT-style collection and item ownership, and auction-based domain allocation. Tests exercise root and collection behavior, item management, auction flow, DNS utility units, and end-to-end paths.

Scripts in `scripts/` are standalone operational entry points:
