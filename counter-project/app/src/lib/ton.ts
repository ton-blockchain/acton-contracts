...
const networkMode = import.meta.env.VITE_TON_NETWORK === 'mainnet' ? 'mainnet' : 'testnet';

export const TON_NETWORK = networkMode === 'mainnet' ? Network.mainnet() : Network.testnet();
...
const toncenterBaseUrl = IS_TESTNET ? 'https://testnet.toncenter.com' : 'https://toncenter.com';
...
export const TONVIEWER_URL = IS_TESTNET ? 'https://testnet.tonviewer.com' : 'https://tonviewer.com';
